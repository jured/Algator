...
public class VMEPExecute {
  ...
  private static void printMsg(Options options) {
    ...
    formatter.printHelp("main.algator.VMEPExecute [options] project_name algorithm_name testset_name test_number comm_folder", options);
  ...
  public static Object runWithVMEP(String project_name, String alg_name, String testset_name,
    ...
    try {
      ...
      String[] command = {jvmCommand, "-cp", classPath, "-Xss1024k", "main.algator.VMEPExecute",
