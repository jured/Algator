...
public class ADEGlobal {
  ...
  public static final String REQ_USERS            = "USERS";          // users (povezava do programa main.algator.Users)
  public static final String REQ_ADMIN            = "ADMIN";          // admin (povezava do programa main.algator.Admin)
