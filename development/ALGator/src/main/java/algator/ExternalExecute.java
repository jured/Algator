 ...
 * 2) execute "java main.algator.ExternExecute cFolder"
...
public class ExternalExecute {
  ...
  private static void printMsg(Options options) {
    ...
    formatter.printHelp("main.algator.ExternalExecut <path>", options);
  ...
  public static Object runWithExternalJVM(String folderName, MeasurementType mType, boolean verbose) { 
    try {
      ...
      String[] command = {jvmCommand, "-cp", classPath, "-Xss1024k", "main.algator.ExternalExecute", folderName};
