...
public class DatabaseInit {
  ...
  public static void init() {
    ...
    //add main.algator, everyone and permissions
    insertAlgator();
    insertEveryone();
  ...
  private static boolean insertAlgator() {
    try {
      ...
      if (rs.next()) {
        System.out.println("Users main.algator already exists!");
        return false;
      }

      //add main.algator user
      String insert = "INSERT INTO users (id,name,password,status) VALUES (1,main.algator,'root',0);";

      int result = stmt.executeUpdate(insert);

      System.out.println("Usmain.algatortor added!");
