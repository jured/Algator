...
public class ATGlobal {
  ...
  private static final String AT_FILEEXT_project     = "atp";   
  private static final String AT_FILEEXT_algorithm   = "atal";
  private static final String AT_FILEEXT_testset     = "atts";
  private static final String AT_FILEEXT_resultdesc  = "atrd";
  private static final String AT_FILEEXT_query       = "atqd";
  ...
  /**
   * Returns the name of the folder with template file(s) and other java sources.
   * @param projectRoot
   * @return 
   */
  ...
  /**
   * Returns the name of a test set configuration file. This file is placed in the 
   * projects tests folder
   */
