...
public class Executor {
  ...
  public static ErrorStatus algorithmRun(Project project, String algName, String testSetName,
    ...
    if (resDesc == null) {
      log.warn(ErrorStatus.ERROR_INVALID_RESULTDESCRIPTION.toString());
    ...
    if (eAlgorithm == null) {
      log.warn(ErrorStatus.ERROR_INVALID_ALGORITHM.toString());
    ...
    if (eTestSet == null) {
      log.warn(ErrorStatus.ERROR_INVALID_TESTSET.toString());
